...
def preparation_time_in_minutes (number_of_layers):
    ...
    :param number_of_layers: int how many lasagna layers you want to cook.
    :return: int time required derived from 'EXPECTED_BAKE_TIME'.

    Function that takes how many lasagna layers you want to cook and returns
