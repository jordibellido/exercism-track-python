...
def tag_special_ingredients (dish):
    ...
    allergens   = ingredients.intersection (SPECIAL_INGREDIENTS)
...
def separate_appetizers (dishes, appetizers):
    ...
    dishes_deduped     = set (dishes)
    appetizers_deduped = set (appetizers)

    return dishes_deduped.difference (appetizers_deduped)
