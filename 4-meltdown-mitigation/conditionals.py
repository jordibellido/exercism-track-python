"""
Exercise 4 - Meltdown Mitigation exercise
"""
...
def reactor_efficiency (voltage, current, theoretical_max_power):
    ...
    voltage_float               = round (float (voltage), 5)
    current_float               = round (float (current), 5)
    theoretical_max_power_float = round (float (theoretical_max_power), 5)

    generated_power             = voltage_float * current_float
    efficiency                  = (generated_power / theoretical_max_power_float) * 100
